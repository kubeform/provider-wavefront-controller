...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-alert-wavefront-kubeform-com-v1alpha1-alert,mutating=false,failurePolicy=fail,groups=alert.wavefront.kubeform.com,resources=alerts,versions=v1alpha1,name=alert.alert.wavefront.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
func (r *Alert) ValidateUpdate(old runtime.Object) error {
	...
	for key, _ := range alertForceNewList {
