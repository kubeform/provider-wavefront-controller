...
// +kubebuilder:rbac:groups=alert.wavefront.kubeform.com,resources=alerts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=alert.wavefront.kubeform.com,resources=alerts/status,verbs=get;update;patch
...
func (r *AlertReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &alertv1alpha1.Alert{}); err != nil {
			klog.Error(err, "unable to set up auditor", alertv1alpha1.Alert{}.APIVersion, alertv1alpha1.Alert{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&alertv1alpha1.Alert{}).
