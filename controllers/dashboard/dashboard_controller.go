...
// +kubebuilder:rbac:groups=dashboard.wavefront.kubeform.com,resources=dashboards,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dashboard.wavefront.kubeform.com,resources=dashboards/status,verbs=get;update;patch
...
func (r *DashboardReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dashboardv1alpha1.Dashboard{}); err != nil {
			klog.Error(err, "unable to set up auditor", dashboardv1alpha1.Dashboard{}.APIVersion, dashboardv1alpha1.Dashboard{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dashboardv1alpha1.Dashboard{}).
